...
r0 = [1.0,0.,0.,0.] #initial condition, spin up: {{1+0j},{0+0j}}
...
ax.annotate("Transition rate = %0.2f"%transition_rate, (0.66,0.685),xycoords = "figure fraction", fontsize =20)
...
w_list = np.arange(0.4,1.4,0.005)
...
w0_slider = Slider(ax=ax_w0,label='$\omega_0$',valmin=0.,valmax=2.,valinit=1.0, facecolor='#cc7000',dragging= True)
w1_slider = Slider(ax=ax_w1,label='$\omega_1$',valmin=0.,valmax=1.,valinit=0.4, facecolor='#cc7000',dragging= True)
t_slider = Slider(ax=ax_t,label='N steps',valmin=100.,valmax=1000.,valfmt='%0.0f',valinit=600,facecolor='#cc7000',dragging= True)
